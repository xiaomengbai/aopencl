...
/** instruct to load followig .so files (in the order for resolving
related OpenCL shared libraries.

  @param libs Null terminated C-String wih absolute path for .so libraries
  @param len  number libraries in libs
